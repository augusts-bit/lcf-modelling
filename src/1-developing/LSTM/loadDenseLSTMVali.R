...
# Write to csv 
write.csv(dense_vali, paste0(linkData, "Processed/Validation/dense_vali_input.csv"))
...
write.csv(dense_vali_noXY, paste0(linkData, "Processed/Validation/dense_vali_input_noXY.csv"))
...
write.csv(targets, paste0(linkData, "Processed/Validation/dense_vali_targets.csv"))
...
write.csv(targets_noXY, paste0(linkData, "Processed/Validation/dense_vali_targets_noXY.csv"))
