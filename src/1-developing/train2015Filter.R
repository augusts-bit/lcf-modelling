...
write.csv(DFcoords, paste0(linkData, "Processed/Training/LSTimeSeries/IIASAtrainingCoords.csv"), row.names=F)
...
coordsData = read.csv(paste0(linkData, "Processed/Training/LSTimeSeries/IIASAtrainingCoords.csv"))
...
st_write(b2FilteredSF, "C:/Processed/Training/LSTimeSeries/b2Filtered.gpkg")
...
st_write(b1FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b1")
st_write(b2FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b2")
st_write(b3FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b3")
st_write(b4FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b4")
st_write(b5FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b5")
st_write(b6FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b6")
st_write(b7FilteredSF, paste0(linkData,"Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b7")

# test multiple layers
st_read(paste0(linkData, "Processed/Training/LSTimeSeries/IIASAtrainingFiltered.gpkg"), "b2")
