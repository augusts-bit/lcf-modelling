...
## Read validation data as made using Rob's method ##

# Change vali is the same as the vali made before as they are from the WUR change data set 
change_vali2015 <- read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2015/vali2015.csv")
change_vali2016 <- read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2016/vali2016.csv")
change_vali2017 <- read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2017/vali2017.csv")
change_vali2018 <- read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2018/vali2018.csv")
...
# linkWURvali = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURvalidationFiltered.gpkg"
# nameBands <- st_layers(linkWURvali)

# coords = read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURvalidationIDCoords.csv")
# setnames(coords, old = c('sample_id','subpix_mean_x','subpix_mean_y'),
#          new = c('sample_id','x','y'))
# coords = coords[,c("x", "y")]
...
write.csv(change_vali, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/LSTM/Input/vali20152018.csv")
