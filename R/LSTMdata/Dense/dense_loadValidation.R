...
linkWURvali = InputLink = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURChangeFiltered.gpkg"
...
dense_vali <- cbind(seq_ID, seq_x, seq_y, seq_dates, seq_b1, seq_b2, seq_b3, seq_b4, seq_b5, seq_b6, seq_b7)

# Rename columns
colnames(dense_vali)[colnames(dense_vali) %in% c("seq_ID", "seq_x", "seq_y", "seq_dates")] <- c("location_id", "x", "y", "date")

# Write to csv 
write.csv(dense_vali, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/LSTM/Input/Dense/dense_vali_input.csv")

# (+ one without X and Y)
dense_vali_noXY <- dense_vali
dense_vali_noXY$x <- NULL
dense_vali_noXY$y <- NULL

write.csv(dense_vali_noXY, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/LSTM/Input/Dense/dense_vali_input_noXY.csv")
...
write.csv(targets, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/LSTM/Input/Dense/dense_vali_targets.csv")
...
write.csv(targets_noXY, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/LSTM/Input/Dense/dense_vali_targets_noXY.csv")
