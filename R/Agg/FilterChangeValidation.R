...
write.csv(DFcoords, paste0(linkData, "Processed/WURChangeCoords.csv"), row.names=F)
...
st_write(b1FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b1", delete_layer = TRUE)
st_write(b2FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b2", delete_layer = TRUE)
st_write(b3FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b3", delete_layer = TRUE)
st_write(b4FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b4", delete_layer = TRUE)
st_write(b5FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b5", delete_layer = TRUE)
st_write(b6FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b6", delete_layer = TRUE)
st_write(b7FilteredSF, paste0(linkData,"Processed/WURChangeFiltered.gpkg"), "b7", delete_layer = TRUE)

# test multiple layers
st_read(paste0(linkData, "Processed/WURChangeFiltered.gpkg"), "b2")
