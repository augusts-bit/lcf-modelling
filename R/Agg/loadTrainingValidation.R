...
linkIIASAtrain = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/IIASAtrainingFiltered.gpkg"
nameBands <- st_layers(linkIIASAtrain)
coords = read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireHarmonics_yearFeatures/trainingLocationID2015.csv")
coords = coords[,c("x", "y")]
ID = read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireHarmonics_yearFeatures/trainingLocationID2015.csv")
...
st_write(VIs2015SF, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Training/entire_timeseries_IIASAtrainingVIs.gpkg", delete_layer = TRUE)


# Split data into 2015, 2016, 2017 and 2018

# 2015
b42015 = b4 # So for training, Rob actually also took the bands of the entire time series
b52015 = b5
b62015 = b6
b72015 = b7
...
# write median and iqr VIs
VIs2015SF = DFtoSF(VIs2015)
st_write(VIs2015SF, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Training/2015/IIASAtrainingVIs.gpkg", delete_layer = TRUE)
...
## WUR change
# linkWURchange = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURvalidationFiltered.gpkg"
linkWURchange = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURChangeFiltered.gpkg"
...
VIs2015 = data.frame(coordsID, 
                     ...
                     nbr2015iqr, ndmi2015iqr, ndvi2015iqr)
# write median and iqr VIs
# VIs2015SF = DFtoSF(VIs2015, validation = TRUE, coords = c("subpix_mean_x","subpix_mean_y"))
VIs2015SF = DFtoSF(VIs2015, validation = TRUE, coords = c("sample_x","sample_y"))
st_write(VIs2015SF, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2015/WURchangeVIs.gpkg", delete_layer = TRUE)
...
# write median and iqr VIs
# VIs2016SF = DFtoSF(VIs2016, validation = TRUE, coords = c("subpix_mean_x","subpix_mean_y"))
VIs2016SF = DFtoSF(VIs2016, validation = TRUE, coords = c("sample_x","sample_y"))
st_write(VIs2016SF, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2016/WURchangeVIs.gpkg", delete_layer = TRUE)
...
# write median and iqr VIs
# VIs2017SF = DFtoSF(VIs2017, validation = TRUE, coords = c("subpix_mean_x","subpix_mean_y"))
VIs2017SF = DFtoSF(VIs2017, validation = TRUE, coords = c("sample_x","sample_y"))
st_write(VIs2017SF, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2017/WURchangeVIs.gpkg", delete_layer = TRUE)
...
# write median and iqr VIs
# VIs2018SF = DFtoSF(VIs2018, validation = TRUE, coords = c("subpix_mean_x","subpix_mean_y"))
VIs2018SF = DFtoSF(VIs2018, validation = TRUE, coords = c("sample_x","sample_y"))
st_write(VIs2018SF, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2018/WURchangeVIs.gpkg", delete_layer = TRUE)
...
# dates = dates[grepl("2015",dates)] # So, don't take harmonics of only 2015, but of entire time series
NewColDates = paste0("X", gsub("-", ".", dates))
...
# Merge data
# ID = read.csv("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireHarmonics_yearFeatures/trainingLocationID2015.csv")
VIS = st_read("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Training/2015/IIASAtrainingVIs.gpkg")

train2015 <- cbind(VIS, HarmMetrics)

# Now add fractions
filename = "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireHarmonics_yearFeatures/training_data_2015_100m_20190402_V4_August.xlsx" #use this csv!!!
...
# train2015 <- train2015[!is.na(train2015$nbr2015median),] # Now x observations
...
write.csv(train2015, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Training/2015/train2015.csv")

## Validation
vali2015_VIS = st_read("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2015/WURchangeVIs.gpkg")
vali2016_VIS = st_read("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/validation/2016/WURchangeVIs.gpkg")
vali2017_VIS = st_read("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2017/WURchangeVIs.gpkg")
vali2018_VIS = st_read("C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2018/WURchangeVIs.gpkg")

# Harmonics
# InputLink = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURvalidationFiltered.gpkg"
InputLink = "C:/Users/augus/Documents/Studie/MGI/Thesis/Rob's/Data/Processed/WURChangeFiltered.gpkg"
...
# vali2015 <- merge(vali2015,validationRaw2015, by = c("sample_id"))
# vali2016 <- merge(vali2016,validationRaw2016, by = c("sample_id"))
# vali2017 <- merge(vali2017,validationRaw2017, by = c("sample_id"))
# vali2018 <- merge(vali2018,validationRaw2018, by = c("sample_id"))
...
# Write to csv
write.csv(vali2015, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2015/vali2015.csv")
write.csv(vali2016, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2016/vali2016.csv")
write.csv(vali2017, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2017/vali2017.csv")
write.csv(vali2018, "C:/Users/augus/Documents/Studie/MGI/Thesis/DataAugust/entireTrain_3yearVali/Validation/2018/vali2018.csv")

# vali2015 has most IDs: 28,878
not2016 <- subset(vali2016, !(sample_id %in% vali2015$sample_id)) # 136
not2017 <- subset(vali2017, !(sample_id %in% vali2015$sample_id)) # 232
not2018 <- subset(vali2018, !(sample_id %in% vali2015$sample_id)) # 276

# Does not add up to 30,489
